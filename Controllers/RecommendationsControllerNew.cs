...
//                     {
//                         name = e.Label,
//                         p = e.RecomOrgs.Sum(r => r.Recommendation.EtatAvancementChiffre) / recommendationsCount/*e.RecomOrgs.Count()*/,
...
//                         id = e.Id,
//                         table = e.Label,
//                         value = e.Recommendations.Sum(r => r.EtatAvancementChiffre) / recommendationsCount/*e.Recommendations.Count()*/
//                     })
//                    .ToListAsync()
//                 ;
...
//                 {
//                     name = e.Key,
//                     p = e.Sum(r => r.EtatAvancementChiffre) / recommendationsCount/*e.Count()*/,
...
//                     .Select(e => e.Recommendations.Sum(r => r.EtatAvancementChiffre) / recommendationsCount/*e.Recommendations.Count()*/)
//                     .FirstOrDefaultAsync()
//                 ;
...
//                     {
//                         table = e.Label,
//                         value = type == "count" ? (double.Parse(e.Recommendations.Count().ToString()) / recommendationsCount) * 100 : (e.Recommendations.Sum(r => r.EtatAvancementChiffre) / recommendationsCount/*e.Recommendations.Count()*/),
//                     })
//                     .Distinct()
//                     .ToListAsync()
//                 ;
